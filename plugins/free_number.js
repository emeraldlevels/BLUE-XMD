...
async (conn, mek, m, { from, args, reply, prefix }) => { // Added prefix parameter
    try {
        ...
        reply(`${errorMessage}\n\n🔑 Remember: ${prefix}otpbox <number>`); // Fixed prefix usage
    }
});
...
async (conn, mek, m, { reply }) => { // Added consistent parameters
    try {
...
async (conn, mek, m, { from, args, reply }) => {
    try {
        ...
        // Add + if missing but number looks complete
