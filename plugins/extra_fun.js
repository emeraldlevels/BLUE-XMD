...
cmd({
    ...
    let roasts = [
        "Bro, your IQ is lower than a WiFi signal in the basement!",
        "Your brain works like a Windows XP system – slow and outdated!",
        "You think too much, are you trying to join NASA?",
        "Who are you? Even Google doesn’t recognize you!",
        "Your brain runs on 2G speed in a 5G world!",
        "Don’t overthink, your battery will die early!",
        "Your ideas are like a cricket match – they stop working when it rains!",
        "You’re VIP: Very Idiotic Person!",
        "You’re like a broken app – crashing when people need you most!",
        "Your personality is like a dead battery – it needs charging badly!",
        "You’re basically a walking error message!",
        "Your jokes are like bad software updates – never funny and always laggy!",
        "Your brain is like a broken link – nothing useful comes out of it!",
        "You look like an iPhone from outside but run like a cheap Android inside!",
        "Your face should come with a warning sign: 'Too much stupidity ahead!'",
        "You’re the human version of '404 Not Found'.",
        "Your thinking speed makes Google buffering look fast.",
        "You are like an empty hard drive – nothing valuable inside!",
        "You’re the kind of person who forgets their own life password!",
        "Your decisions are so confusing that even quiz show hosts would give up!",
        "Talking to you is like facing an unknown error – no solution exists!",
        "Your life is always 'under construction' but never finished!",
        "You are the reason group chats come with a mute button!",
        "You think you’re the hero, but in reality, you’re the side villain.",
        "Your face looks like a screenshot – flat and fake!",
        "You’re basically a living meme, nothing more!",
        "Your ideas are stuck in 'buffering mode'.",
        "You act like an antivirus, but you’re actually the virus!",
        "Your brain needs a restart more than Windows does.",
        "Your life should come with an 'Error 500: Internal Fool' message!"
    ];               
        
    let randomRoast = roasts[Math.floor(Math.random() * roasts.length)];
    
    // FIXED: Check if mek.sender exists before trying to split it
    let sender = mek && mek.sender ? `@${mek.sender.split("@")[0]}` : "Unknown";
    let mentionedUser = m.mentionedJid && m.mentionedJid[0] || (mek.quoted && mek.quoted.sender);
